...
import {
  MapPin, Users, ArrowRight, Calendar
} from 'lucide-react';

const ATTRACTION_IMAGES = {
  "Cellular Jail National Memorial": "/images/cellular-jail.jpg",
  "Cellular Jail Light & Sound Show": "/images/cellular-jail.jpg",
  "Ross Island (Netaji Subhash Chandra Bose Dweep)": "/images/ross-island-ruins.jpg",
...
export function AttractionsExplorer({ onAddToCart, onRequireLogin, user }) {
            ...
            >
              <div>
                ...
                <div className="relative h-44 overflow-hidden">
                  ...
                  {/* Category Pill */}
                  <span className="absolute top-3 left-3 px-3 py-1 rounded-full text-[10px] font-extrabold uppercase tracking-wider bg-navy-900/85 backdrop-blur-md text-cyan-200">
                ...
                <div className="p-5">
                  <span className="flex items-center gap-1 text-[11px] font-semibold text-slate-400 mb-1">
                    <MapPin className="w-3.5 h-3.5 text-cyan-600" /> {item.island.replace('_', ' ')}
                  </span>
